...
function divWithClassGenerate() {
  for (let i = 0; i < divsWithClassLength; i++) {
    const divWithClass = document.createElement("div")
    divWithClass.classList.add("taken")
    grid.appendChild(divWithClass)
  }
}
divWithClassGenerate()
